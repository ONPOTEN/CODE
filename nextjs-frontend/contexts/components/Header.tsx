      ...
      <div className="container">
        ...
        <div className="flex items-center justify-between py-3">
          ...
          <div className="flex items-center gap-6">
            {/* Menu thả xuống hồ sơ người dùng */}
            {isAuthenticated ? (
              <div className="hidden md:block relative">
                ...
                >
                  ...
                  <span className="text-sm">{user?.username || 'Tài khoản'}</span>
            ...
            <ul className="space-y-4">
              {isAuthenticated ? (
                <>
                  ...
                  <li>
                    <Link href="/notifications" className="block py-2">
                      Thông báo
                    </Link>
                  </li>
                  {isAdmin(user) && (
