  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-grey-200 border-b border-gray-300">
        ...
        <div className="relative h-48 md:h-64 bg-gradient-to-r from-blue-400 to-blue-600 overflow-visible pb-12 md:pb-16">
          {group.cover_image ? (
            <img
            ...
            <div className="w-full h-48 md:h-64 flex items-center justify-center bg-gradient-to-br from-blue-400 to-blue-600">
              <svg className="w-16 h-16 md:w-24 md:h-24 text-blue-200 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 flex items-center justify-center z-10">
            {group.avatar ? (
              ...
              <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-white shadow-lg bg-blue-300 flex items-center justify-center">
                <svg className="w-12 h-12 md:w-16 md:h-16 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="max-w-4xl mx-auto px-4 pt-16 md:pt-20 pb-6 md:pb-8">
          <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-2 text-center break-words">{group.group_name}</h1>
          {group.description && <p className="text-gray-600 text-sm md:text-lg mb-4 text-center">{group.description}</p>}

          {/* Group Stats */}
          <div className="flex gap-4 md:gap-8 mb-4 justify-center flex-wrap">
          ...
          {(() => {
            ...
            return (
              <>
                {/* Action Buttons */}
                <div className="flex gap-2 md:gap-3 flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-center mt-6">
        ...
        {isMember && (
          <div className="max-w-4xl mx-auto px-4 mt-6 md:mt-8 flex gap-4 md:gap-8 justify-center sm:justify-start overflow-x-auto">
            <Link
