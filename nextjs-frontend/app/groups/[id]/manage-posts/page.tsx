  ...
  const fetchData = async () => {
    try {
      ...
      if (currentUser && groupData.group_owner_id !== currentUser.id) {
        setError('Bạn không có quyền quản lý bài viết trong nhóm này');
        return;
      }
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mt-4">Quản lý nhóm</h1>
          <p className="text-gray-600 mt-2">Quản lý người dùng nhóm và duyệt/quản lý bài viết</p>
        </div>
          ...
          <div className="flex border-b border-gray-300">
            <button
              ...
              className={`flex-1 px-6 py-4 font-medium transition-colors ${
                activeTab === 'pending'
                  ? 'text-amber-600 border-b-2 border-amber-600 bg-blue-500'
            ...
            <button
              ...
              className={`flex-1 px-6 py-4 font-medium transition-colors ${
                activeTab === 'approved'
                  ? 'text-green-600 border-b-2 border-green-600 bg-grey-200'
                  : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              <div className="flex items-center justify-center gap-2">
