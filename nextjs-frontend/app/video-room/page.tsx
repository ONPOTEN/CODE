  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Video Call Room</h1>
          <p className="text-gray-600">
            Room: <span className="font-semibold text-indigo-600">{roomId}</span>
          </p>
                  ...
                  <div className="text-gray-600 mb-4">
                    {connectionStatus === 'waiting' ? (
                      <>
                        ...
                        <p className="text-sm mt-2">Share this room ID with your peer</p>
                      </>
                    ) : (
        ...
        <div className="mt-8 bg-grey-200 rounded-lg shadow-lg p-6 text-gray-700">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <span className="font-semibold">Connected User:</span>{' '}
              {remoteUser?.email || 'None'}
            </li>
            <li>
