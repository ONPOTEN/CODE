  ...
  return (
    <div className="bg-green-50 border border-green-200 rounded-lg p-6 space-y-6">
      ...
      <p className="text-sm text-gray-600">
        Add product descriptions, categories, downloadable files and external links for your digital product.
      </p>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
          placeholder="Brief summary of the download product"
          maxLength={255}
        />
      ...
      <div>
        ...
        <textarea
          ...
          rows={5}
          className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
          placeholder="Detailed information about the download product"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
          placeholder="e.g., Software, Templates, eBooks, Tools"
        />
      </div>
        ...
        {mainImagePreview ? (
          <div className="space-y-3">
            ...
            <label className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-green-300 rounded-lg cursor-pointer bg-green-50 hover:bg-green-100 transition-colors">
              <div className="flex flex-col items-center justify-center pt-2 pb-2">
                ...
                <p className="text-xs text-green-600">Click to replace image</p>
              </div>
          ...
          <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-green-300 rounded-lg cursor-pointer bg-green-50 hover:bg-green-100 transition-colors">
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              ...
              <p className="text-sm text-green-600 font-medium">Upload Main Image</p>
      ...
      <div>
        ...
        <label className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-green-300 rounded-lg cursor-pointer bg-green-50 hover:bg-green-100 transition-colors">
          <div className="flex flex-col items-center justify-center pt-2 pb-2">
            ...
            <p className="text-xs text-green-600 font-medium">Click or drag to add more images</p>
          </div>
      ...
      <div className="border border-green-300 rounded-lg p-4 bg-white">
        ...
        {!downloadFile && (
          <div className="space-y-3 mb-4">
            ...
            <p className="text-xs text-gray-500 text-center">
              Supported: Any file type (zip, pdf, exe, etc.)
            </p>
          </div>
        )}
          ...
          <div className="space-y-3">
            <div className="flex items-start justify-between bg-green-50 p-4 rounded border border-green-200">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">Size: {downloadFile.size}</p>
              </div>
              <button
                type="button"
        ...
        {!downloadFile && (
          <p className="text-sm text-gray-500 italic text-center">No file selected.</p>
        )}
      </div>
