...
export default function ShopMessagesPage() {
  ...
  const fetchMessageStats = async () => {
    try {
      ...
      setError(
        err instanceof Error ? err.message : 'Không thể tải thống kê tin nhắn'
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Vui lòng đăng nhập để xem tin nhắn cửa hàng của bạn
          </p>
          <Link
            href="/login"
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Đang tải tin nhắn cửa hàng...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Quản lý tin nhắn khách hàng cho cửa hàng của bạn
              </p>
            </div>
            <Link
              href="/my-shops"
        ...
        {messageStats.length === 0 ? (
          <div className="bg-grey-200 rounded-lg shadow-sm p-12 text-center">
            ...
            <p className="text-gray-600 text-sm mb-6">
              Khi khách hàng gửi tin nhắn đến cửa hàng của bạn, tin nhắn sẽ hiển thị ở đây
            </p>
            <Link
              href="/my-shops"
                  ...
                  <div className="space-y-2 text-sm text-gray-600 mb-4">
                    ...
                    {stat.lastMessage && (
                      <div className="pt-2 border-t border-gray-300 mt-2">
                        <p className="text-xs text-gray-500 font-medium">Tin nhắn mới nhất</p>
                        <p className="text-xs text-gray-700 italic mt-1 line-clamp-2">
                          "{stat.lastMessage}"
                        </p>
                        <p className="text-xs text-gray-500 mt-1">
                          từ {stat.lastMessageSender}
                        </p>
