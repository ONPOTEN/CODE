...
export default function MyShopsPage() {
        ...
        for (const shop of shopsData) {
          try {
            ...
            if (messages.length > 0) {
              ...
              lastMessageSender = msg.sender?.display_name || msg.sender?.name || 'Khách hàng';
            }
        ...
        setMessageStats((prevStats) => {
          ...
          return {
            ...
            [message.shopId]: {
              ...
              lastMessageSender: message.userName || 'Khách hàng',
  ...
  const generateQRCode = async () => {
    ...
    try {
      ...
      const errorMsg = err instanceof Error ? err.message : 'Không thể tạo mã QR';
