    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
          ...
          <Link
            href="/profile"
            className="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 bg-blue-500 hover:bg-blue-700 text-gray-900 rounded-lg font-medium transition-colors"
          >
              ...
              {friendsList.map((friend) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    {/* Actions */}
                    <div className="flex flex-col sm:flex-row w-full sm:w-auto items-stretch sm:items-center gap-2 mt-4 sm:mt-0 sm:ml-4">
                      {/* Chat Button */}
                      <ChatButton userId={friend.id} userName={friend.name} className="w-full sm:w-auto inline-flex justify-center items-center" />

                      <Link
                        href={`/users/${friend.id}`}
                        className="w-full sm:w-auto inline-flex justify-center items-center gap-1 px-4 py-2 bg-blue-500 hover:bg-blue-700 text-gray-900 rounded-lg font-medium transition-colors"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto inline-flex justify-center items-center gap-1 px-4 py-2 bg-blue-500 hover:bg-blue-700 text-gray-900 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
