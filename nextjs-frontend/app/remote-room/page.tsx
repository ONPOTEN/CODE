  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-100 p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Phòng người tham gia</h1>
          <p className="text-gray-600">
            Bạn đã được mời tham gia cuộc gọi video.
          </p>
        ...
        {isWaitingForInvite && (
          <div className="mb-8 bg-grey-200 border-l-4 border-blue-500 p-6 rounded-lg">
            <p className="text-blue-800 font-semibold">
              Đang đợi chủ trì tham gia cuộc gọi...
            </p>
            <p className="text-blue-600 text-sm mt-2">
              Vui lòng đợi trong khi chủ trì chuẩn bị. Video sẽ bắt đầu tự động.
            </p>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          {/* Local Video */}
          <div className="bg-grey-200 rounded-lg shadow-xl overflow-hidden border-4 border-teal-400">
                ...
                <div className="text-center">
                  <div className="text-gray-600">
                    {isWaitingForInvite ? (
                      ...
                      <>
                        <p className="text-lg">Video của chủ trì sẽ hiển thị ở đây</p>
                        <p className="text-sm mt-2">Đang đợi chủ trì bắt đầu cuộc gọi</p>
                      </>
                    )}
                  </div>
                </div>
        ...
        <div className="bg-grey-200 rounded-lg shadow-lg p-6 text-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              <span className="font-semibold text-teal-600">Email của bạn:</span>
              <p className="text-gray-600">{user?.email}</p>
            </div>
            <div>
              <span className="font-semibold text-indigo-600">Chủ trì:</span>
