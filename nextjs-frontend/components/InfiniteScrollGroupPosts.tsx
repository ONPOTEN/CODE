              ...
              {postsList.map((post, index) => {
                return (
                  <Fragment key={post.id}>
                    {/* Inline Suggested Groups BEFORE the 2nd post */}
                    {index % 10 === 1 && (
                      <div className="w-full border-b border-gray-200 pb-4 pt-4 overflow-hidden">
                        <SuggestedGroups currentGroupId={groupId} layout="horizontal" />
                      </div>
                    )}
                    <article
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    Thêm hình ảnh ({existingImages.length + editImages.length}/10)
                  </button>
                </div>
