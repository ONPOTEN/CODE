...
Route::middleware('auth:sanctum')->prefix('v1')->group(function () {
    ...
    Route::post('/s3/video/presigned-url', [S3Controller::class, 'generateVideoPresignedUrl'])
        ->middleware('throttle.advanced:upload');
    ...
    // Video upload for regular posts (background processing)
    Route::post('/posts/{id}/video', [PostController::class, 'uploadVideo'])->where('id', '[0-9]+');
    Route::get('/posts/{id}/video-status', [PostController::class, 'getVideoStatus'])->where('id', '[0-9]+');
    ...
    // Video upload for existing posts (background processing)
    Route::post('/shops/{shopId}/posts/{id}/video', [ShopPostController::class, 'uploadVideo'])->where(['shopId' => '[0-9]+', 'id' => '[0-9]+']);
    Route::get('/shops/{shopId}/posts/{id}/video-status', [ShopPostController::class, 'getVideoStatus'])->where(['shopId' => '[0-9]+', 'id' => '[0-9]+']);
    ...
    Route::prefix('shops/{shopId}/messages')->group(function () {
        ...
        Route::post('/{messageId}/pin', [ShopMessageController::class, 'pinMessage'])->where(['shopId' => '[0-9]+', 'messageId' => '[0-9]+']);
        Route::post('/{messageId}/react', [ShopMessageController::class, 'toggleReaction'])->where(['shopId' => '[0-9]+', 'messageId' => '[0-9]+']);
    });
    ...
    Route::prefix('notifications')->group(function () {
        Route::get('/count', [NotifyController::class, 'getCount']);
        Route::get('/', [NotifyController::class, 'index']);
        Route::post('/{id}/mark-read', [NotifyController::class, 'markAsRead'])->where('id', '[0-9]+');
        Route::post('/mark-all-read', [NotifyController::class, 'markAllAsRead']);
    });
    ...
    Route::post('/conversations/{conversationId}/messages/{messageId}/pin', [ChatController::class, 'pinMessage'])->where(['conversationId' => '[0-9]+', 'messageId' => '[0-9]+']);
    Route::post('/conversations/{conversationId}/messages/{messageId}/react', [ChatController::class, 'toggleReaction'])->where(['conversationId' => '[0-9]+', 'messageId' => '[0-9]+']);
    ...
    Route::post('/conversations/{conversationId}/read', [ChatController::class, 'markAsRead'])->where('conversationId', '[0-9]+');
